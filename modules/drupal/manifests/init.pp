...
class drupal {
  ...
  # Download Drupal: http://ftp.drupal.org/files/projects/drupal-7.26.tar.gz

  exec { 'download-drupal':
    command => 'wget http://ftp.drupal.org/files/projects/drupal-7.26.tar.gz',
    cwd     => '/vagrant/webroot/',
  ...
  exec { 'tar-drupal':
    cwd     => '/vagrant/webroot/',
    command => 'tar -xzvf drupal-7.26.tar.gz --strip 1',
